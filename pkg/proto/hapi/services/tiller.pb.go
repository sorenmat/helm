...
func (ListSort_SortBy) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{2, 0} }
...
func (ListSort_SortOrder) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{2, 1} }
...
func (*ListSort) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{2} }
...
func (*ListReleasesResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{3} }
...
func init() {
	proto.RegisterType((*Void)(nil), "hapi.services.tiller.Void")
...
type ReleaseServiceClient interface {
	...
	PingTiller(ctx context.Context, in *google_protobuf2.Empty, opts ...grpc.CallOption) (*google_protobuf2.Empty, error)
}
...
func (c *releaseServiceClient) PingTiller(ctx context.Context, in *google_protobuf2.Empty, opts ...grpc.CallOption) (*google_protobuf2.Empty, error) {
...
type ReleaseServiceServer interface {
	...
	// PingTiller sends a test/ping signal to Tiller to ensure that it's up
	PingTiller(context.Context, *google_protobuf2.Empty) (*google_protobuf2.Empty, error)
}
...
func _ReleaseService_PingTiller_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReleaseServiceServer).PingTiller(ctx, req.(*google_protobuf2.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var fileDescriptor0 = []byte{
	...
	,
}
